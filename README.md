...
5. Carregue a TSP digitando "2"
   <img width="318" height="318" alt="image" src="https://github.com/user-attachments/assets/2bac90f1-37b5-4be4-a399-d47f51837101" />
6. Escolha o arquivo para ser carregado
   <img width="322" height="532" alt="image" src="https://github.com/user-attachments/assets/a3b8e12e-fb9b-44a2-9211-93492b5a89ad" />
7. Agora é possivel verificar se a matriz foi corretamente carregada com "print", utilizar o algoritmo para a TSP aproximada com o "Execute TSP Aproximated", utilizar o algoritmo de força bruta com "Execute TSP Brute Force", ou sair da execução com "Exit Program"
